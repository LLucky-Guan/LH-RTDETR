...
class DETRLoss(nn.Module):
    ...
    def __init__(self,
        ...
        if self.use_wiseiou: # Best Score：SIOU focaler 0.75
            self.wiou_loss = WiseIouLoss(ltype='SIoU', monotonous=False, inner_iou=False, focaler_iou=True)
    ...
    def _get_loss_bbox(self, pred_bboxes, gt_bboxes, postfix=''):
        ...
        if self.use_wiseiou:
            loss[name_giou] = self.wiou_loss(pred_bboxes, gt_bboxes, ret_iou=False, ratio=0.75, d=0.0, u=0.95)
